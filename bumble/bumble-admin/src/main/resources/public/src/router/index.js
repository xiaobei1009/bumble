...
*   detail see  https://panjiachen.github.io/bumble-admin-site/#/router-and-nav?id=sidebar
**/
...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [{
      ...
      name: 'configuration',
      meta: { title: 'configuration', icon: 'edit', noCache: true }
    }]
  },
  {
    path: '/registry',
    ...
    children: [{
      ...
      name: 'registry',
      meta: { title: 'registry', icon: 'example', noCache: true }
    }]
  },
  {
    path: '/documentation',
