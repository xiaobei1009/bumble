<template>
  <div class="app-container documentation-container">
    <a class="document-btn" target='_blank' href="https://panjiachen.github.io/bumble-admin-site/#/">{{$t('documentation.documentation')}}</a>
    <a class="document-btn" target='_blank' href="https://github.com/PanJiaChen/bumble-admin/">{{$t('documentation.github')}}</a>
